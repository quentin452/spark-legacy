...
public class Forge1122ClientSparkPlugin extends Forge1122SparkPlugin {
    ...
    public Forge1122ClientSparkPlugin(Forge1122SparkMod mod, Minecraft minecraft) {
        ...
        this.threadDumper.setThread(ObfuscationReflectionHelper.getPrivateValue(Minecraft.class, minecraft, "field_152352_aC"));
    }
    ...
    public WorldInfoProvider createWorldInfoProvider() {
        return new Forge1122WorldInfoProvider.Client(Minecraft.getMinecraft());
    }
